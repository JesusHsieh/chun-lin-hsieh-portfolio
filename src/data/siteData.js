...
export const PERSONAL_PROJECTS = [
  ...
  },
  {
    ...
    description: '輕量化的網頁端 3D 模擬工具，用於快速評估小型景觀的光影變化。',
    client: '概念原型',
    area: 'Web 應用程式',
    icon: 'code',
    details: [
      '針對口袋公園或狹小巷弄等微型景觀改造，傳統大型 3D 軟體往往過於笨重。本工具基於 WebGL 技術開發，提供極輕量化的瀏覽器端光影模擬。',
      '使用者只需上傳簡易基地輪廓與周邊建物高度，即可即時模擬一年四季、不同時段的光影分佈與熱輻射情況。',
      '此工具旨在幫助設計師在概念初期階段，就能以數據驅動的方式，做出最符合人體舒適度與植栽日照需求的空間決策。',
    ],
  },
];
...
export const EXPERIENCE = [
  {
    ...
    company: '六國景觀設計有限公司',
    period: '2015 - 2026',
    desc: '主導大型都市規劃與複合式景觀開發案，管理跨國設計團隊，成功導入優化的協作流程。',
  },
  {
    role: '景觀設計師',
    company: '華谷工程顧問有限公司',
    period: '2014 - 2015',
    desc: '專精於高端住宅及企業總部景觀設計，負責從概念發想到施工監造的全程管控。',
  },
  {
    role: '景觀設計師',
    company: '楊天柱建築師事務所',
    period: '2013 - 2014',
    desc: '參與多項公共工程競圖，負責植栽設計、細部圖說繪製及工程估算。',
  },
  {
    role: '室內設計師',
    company: '達奇室內設計裝修有限公司',
    period: '2010 - 2013',
    desc: '協助資深設計師執行初步設計方案，負責基地測繪、植栽資料庫維護及施工詳圖繪製。',
  },
];
